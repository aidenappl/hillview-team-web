		...
		>
			...
			<div className="mt-8 w-full h-[75px] flex justify-end items-center relative">
				...
				<div className="flex gap-1">
					<button className="py-2 px-3.5 text-[#101827] hover:text-black font-semibold rounded-md text-sm">
						Cancel
					</button>
					<button className="w-[60px] h-[36px] flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-md text-sm">
						{loader ? (
